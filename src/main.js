...
onload = (() => {
  // Decorating Range 01
  const rangeMortgage = new Range('[class="rangeMortgage"]', '.rangeMortgage__value', 40, true);
  rangeMortgage.init();

  // Decorating Range 02
  const rangeInterest = new Range('[class="rangeInterest"]', '.rangeInterest__value', 10, false);
  rangeInterest.init();
